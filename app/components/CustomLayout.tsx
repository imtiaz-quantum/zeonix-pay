...
const CustomLayout = ({ children, role, balance, profileData }: CustomLayoutProps) => {
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen gap-6 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
      <SideNav role={role} collapsed={collapsed} toggleSidebar={toggleSidebar} balance={balance} />
      <div className="flex flex-col w-full transition-all duration-300 ease-in-out">
        <Header role={role} collapsed={collapsed} toggleSidebar={toggleSidebar} profileData={profileData ?? undefined} />
        <main
